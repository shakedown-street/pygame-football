...
class Player(pygame.sprite.Sprite):
    ...
    def __str__(self):
        ...
        strength = self.stats.get("change_of_direction", 50)
...
c = Player.from_roster(offense_team, "C")
rg = Player.from_roster(offense_team, "RG")
rt = Player.from_roster(offense_team, "RT")
qb = Player.from_roster(offense_team, "QB")
hb = Player.from_roster(offense_team, "HB")
te = Player.from_roster(offense_team, "TE")
